...
return [
    ...
    'models.db.game.guest' => 'A',
    'models.db.game.home' => 'H',
    ...
    'models.db.user.label.is_no_vice' => 'Do not accept offers to be a substitute',
    'models.db.user.label.is_translation_mode' => 'I want to help translate the site',
    'models.db.user.label.timezone' => 'Timezone',
