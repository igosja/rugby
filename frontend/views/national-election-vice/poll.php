    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                <h4><?= Yii::t('frontend', 'views.national-election-vice.poll.h4') ?></h4>
            </div>
        </div>
        ...
        <?= $form
            ->field($model, 'election_national_vice_application_id')
            ->radioList($electionNationalVice->electionNationalViceApplications, [
                'item' => static function ($index, ElectionNationalViceApplication $model, $name, $checked) {
                    $result = '<div class="row border-top"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">'
                        . Html::radio($name, $checked, [
                            'index' => $index,
                            'label' => $model->user_id ? $model->user->getUserLink() : Yii::t('frontend', 'views.national-election-vice.poll.label.against'),
                            'value' => $model->id,
                        ])
                        . '</div></div>';
                    if ($model->user_id) {
                        $result .= '<div class="row">
                            ...
                            . '</div>
                                ...
                                <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ' . Yii::t('frontend', 'views.national-election-vice.poll.register') . ': '
                            . FormatHelper::asDate($model->user->date_register)
                            . '</div></div>
                            <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ' . Yii::t('frontend', 'views.national-election-vice.poll.rating') . ': '
                            . $model->user->rating
                            . '</div></div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                <?= Html::submitButton(Yii::t('frontend', 'views.national-election-vice.poll.submit'), ['class' => 'btn margin']) ?>
            </div>
        </div>
        <?php ActiveForm::end() ?>
    </div>
