    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 strong text-size-1">
                <?= Yii::t('frontend', 'views.stadium.build.title') ?>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
        <?= Html::submitButton(Yii::t('frontend', 'views.stadium.build.submit'), ['class' => 'btn margin']) ?>
        <?= Html::a(Yii::t('frontend', 'views.stadium.build.link.cancel'), ['increase'], ['class' => 'btn margin']) ?>
    </div>
</div>
<?php ActiveForm::end() ?>
