...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
        <h4><?= Yii::t('frontend', 'views.president.application.h4') ?></h4>
    </div>
</div>
...
<?= $form
    ->field($model, 'text')
    ->textarea(['rows' => 5])
    ->label(Yii::t('frontend', 'views.president.application.label.text')) ?>
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
        <?= Html::submitButton(Yii::t('frontend', 'views.president.application.submit'), ['class' => 'btn margin']) ?>
        <?php if (!$model->isNewRecord) : ?>
            <?= Html::a(Yii::t('frontend', 'views.president.application.delete'), ['delete-application'], ['class' => 'btn margin']) ?>
        <?php endif ?>
    </div>
</div>
<?php ActiveForm::end() ?>
