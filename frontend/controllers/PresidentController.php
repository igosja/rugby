...
class PresidentController extends AbstractController
{
    ...
    public function actionApplication()
    {
        ...
        if ($position) {
            $this->setErrorFlash(Yii::t('frontend', 'controllers.president.application.error'));
            return $this->redirect(['team/view']);
        }
        ...
        $this->setSeoTitle(Yii::t('frontend', 'controllers.president.application.title'));
    ...
    public function actionDeleteApplication(): Response
    {
        ...
        $this->setSuccessFlash(Yii::t('frontend', 'controllers.president.delete-application.success'));
        return $this->redirect(['application']);
    }
    ...
    public function actionView()
    {
        ...
        $this->setSeoTitle(Yii::t('frontend', 'controllers.president.view.title'));
    ...
    public function actionPoll()
    {
        ...
        $model->user_id = $this->user->id;
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            $this->setSuccessFlash(Yii::t('frontend', 'controllers.president.poll.success'));
            return $this->refresh();
        }

        $this->setSeoTitle(Yii::t('frontend', 'controllers.president.poll.title'));
