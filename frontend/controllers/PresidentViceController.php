...
class PresidentViceController extends AbstractController
{
    ...
    public function actionApplication()
    {
        ...
        if ($position) {
            $this->setErrorFlash(Yii::t('frontend', 'controllers.president-vice.application.error'));
            return $this->redirect(['team/view']);
        }
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            $this->setSuccessFlash(Yii::t('frontend', 'controllers.president-vice.application.success'));
            return $this->refresh();
        }

        $this->setSeoTitle(Yii::t('frontend', 'controllers.president-vice.application.title'));
    ...
    public function actionDeleteApplication(): Response
    {
        ...
        $this->setSuccessFlash(Yii::t('frontend', 'controllers.president-vice.delete-application.success'));
        return $this->redirect(['application']);
    }
    ...
    public function actionView()
    {
        ...
        $this->setSeoTitle(Yii::t('frontend', 'controllers.president-vice.view.title'));
    ...
    public function actionPoll()
    {
        ...
        $model->user_id = $this->user->id;
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            $this->setSuccessFlash(Yii::t('frontend', 'controllers.president-vice.poll.success'));
            return $this->refresh();
        }

        $this->setSeoTitle(Yii::t('frontend', 'controllers.president-vice.poll.title'));
