    ...
    public function safeUp(): bool
    {
        $this->createTable(
            ...
            [
                ...
                'draw' => $this->integer(11)->defaultValue(0),
                'draw_equal' => $this->integer(11)->defaultValue(0),
                'draw_strong' => $this->integer(11)->defaultValue(0),
                'draw_weak' => $this->integer(11)->defaultValue(0),
