    ...
    public function safeUp(): bool
    {
        $this->createTable(
            ...
            [
                ...
                'tackle' => $this->integer(2)->defaultValue(0),
                'team_id' => $this->integer(11),
                'try' => $this->integer(1)->defaultValue(0),
                'turnover_won' => $this->integer(2)->defaultValue(0),
