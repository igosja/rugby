    ...
    public function safeUp(): bool
    {
        $this->createTable(
            ...
            [
                ...
                'age_place_country' => $this->integer(11)->defaultValue(0),
                'base_place' => $this->integer(11)->defaultValue(0),
                'base_place_country' => $this->integer(11)->defaultValue(0),
                'finance_place' => $this->integer(11)->defaultValue(0),
                'finance_place_country' => $this->integer(11)->defaultValue(0),
                'player_place' => $this->integer(11)->defaultValue(0),
                'player_place_country' => $this->integer(11)->defaultValue(0),
                'power_vs_place' => $this->integer(11)->defaultValue(0),
                'power_vs_place_country' => $this->integer(11)->defaultValue(0),
                'price_base_place' => $this->integer(11)->defaultValue(0),
                'price_base_place_country' => $this->integer(11)->defaultValue(0),
                'price_stadium_place' => $this->integer(11)->defaultValue(0),
                'price_stadium_place_country' => $this->integer(11)->defaultValue(0),
                'price_total_place' => $this->integer(11)->defaultValue(0),
                'price_total_place_country' => $this->integer(11)->defaultValue(0),
                'salary_place' => $this->integer(11)->defaultValue(0),
                'salary_place_country' => $this->integer(11)->defaultValue(0),
                'stadium_place' => $this->integer(11)->defaultValue(0),
                'stadium_place_country' => $this->integer(11)->defaultValue(0),
                'team_id' => $this->integer(11)->defaultValue(0),
                'visitor_place' => $this->integer(11)->defaultValue(0),
                'visitor_place_country' => $this->integer(11)->defaultValue(0),
            ]
        );
