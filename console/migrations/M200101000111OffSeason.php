...
/**
 * Class M200101000111OffSeason
 * @package console\migrations
 */
class M200101000111OffSeason extends Migration
{
    ...
    public function safeUp(): bool
    {
        ...
        $this->addForeignKey('off_season_season_id', self::TABLE, 'season_id', '{{%season}}', 'id');
        $this->addForeignKey('off_season_team_id', self::TABLE, 'team_id', '{{%team}}', 'id');
