    ...
    public function safeUp(): bool
    {
        $this->createTable(
            ...
            [
                ...
                'date_confirm' => $this->integer(11)->defaultValue(0),
                'date_delete' => $this->integer(11)->defaultValue(0),
                'date_login' => $this->integer(11)->defaultValue(0),
                'date_register' => $this->integer(11)->defaultValue(0),
                'date_vip' => $this->integer(11)->defaultValue(0),
                ...
                'user_role_id' => $this->integer(5)->defaultValue(1),
            ]
        );
